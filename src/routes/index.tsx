...
import { carousels, blogs, newsletters, meta } from "@/lib/goozone-content";

export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "Goozone — Content Preview" },
      {
        name: "description",
        content:
          "Monthly content drop preview for Goozone: Instagram grid, carousels, blog posts and newsletters.",
      },
    ],
  }),
  component: Index,
    ...
    <div className="min-h-screen scroll-smooth bg-background text-foreground">
      ...
      <section className="mx-auto max-w-6xl px-6 pt-16 pb-12">
        ...
        <p className="mt-4 max-w-2xl text-base text-muted-foreground md:text-lg">
          ...
          look at month-end, the 10 carousels, 4 blog posts and 4 newsletters — each with its
          companion story. Content built for seller acquisition across Instagram, Facebook, and TikTok.
        </p>
        <div className="mt-6 flex flex-wrap gap-3">
          <Button asChild>
            <a href="./content-plan.html" target="_blank" rel="noopener noreferrer">
              ...
              <button
                ...
                onClick={() =>
                  ...
                  setLightbox({
                    ...
                    alt: c.title,
                    aspect: "post",
                    downloadFilename: `goozone-carousel-${c.id}-slide-1.png`,
                  })
                }
      ...
      <Section
        id="carousels"
        title="Carousels"
        subtitle="10 carousels for Instagram, Facebook and LinkedIn."
      >
        <div className="space-y-16">
          {carousels.map((c) => (
            <article key={c.id}>
                        ...
                        <button
                          ...
                          onClick={() =>
                            setLightbox({
                              ...
                              aspect: "post",
                              downloadFilename: `goozone-carousel-${c.id}-slide-${i + 1}.png`,
                            })
                          }
              ...
              {c.caption && (
                <div className="mt-4 rounded-xl border border-border bg-gradient-to-br from-muted/20 to-background p-4">
                  <div className="flex items-center justify-between mb-3">
                    ...
                    >
                      {copiedCaptionId === c.id ? "Copied!" : "Copy to clipboard"}
                    </button>
                  </div>
              ...
              <div className="flex gap-4">
                <div className="flex-1">
                  <ImageOrPlaceholder
                    ...
                    alt={b.title}
                    aspect="landscape"
                    downloadFilename={`goozone-blog-${b.id}-banner.png`}
                  />
                </div>
                <button
                  type="button"
                  onClick={() =>
                    ...
                    setLightbox({
                      ...
                      alt: `${b.title} story`,
                      aspect: "portrait",
                      downloadFilename: `goozone-blog-${b.id}-story.png`,
                    })
                  }
              ...
              <button
                ...
                onClick={() =>
                  ...
                  setLightbox({
                    ...
                    alt: n.title,
                    aspect: "landscape",
                    downloadFilename: `goozone-newsletter-${n.id}-banner.png`,
                  })
                }
                  ...
                  <>
                    ...
                    <button
                      ...
                      onClick={(e) => {
                        e.stopPropagation();
                        e.preventDefault();
                        downloadImage(n.banner, `goozone-newsletter-${n.id}-banner.png`);
                      }}
                  ...
                  <button
                    ...
                    onClick={() =>
                      setLightbox({
                        ...
                        alt: `${n.title} story`,
                        aspect: "portrait",
                        downloadFilename: `goozone-newsletter-${n.id}-story.png`,
                      })
                    }
